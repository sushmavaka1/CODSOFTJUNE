...
Button(root,text="/", width=5, height=1,  font=("arial",30,"bold"), bd=1,fg="#fff",bg="#000043",command=lambda: show("/")).place(x=150,y=100)
Button(root,text="%", width=5, height=1,  font=("arial",30,"bold"), bd=1,fg="#fff",bg="#000043",command=lambda: show("%")).place(x=290,y=100)
Button(root,text="*", width=5, height=1,  font=("arial",30,"bold"), bd=1,fg="#fff",bg="#000043",command=lambda: show("*")).place(x=430,y=100)
...
Button(root,text="-", width=5, height=1,  font=("arial",30,"bold"), bd=1,fg="#fff",bg="#000043",command=lambda: show("-")).place(x=430,y=200)
...
Button(root,text="+", width=5, height=1,  font=("arial",30,"bold"), bd=1,fg="#fff",bg="#000043",command=lambda: show("+")).place(x=430,y=300)
...
Button(root,text=".", width=5, height=1,  font=("arial",30,"bold"), bd=1,fg="#fff",bg="#000043",command=lambda: show(".")).place(x=290,y=500)
